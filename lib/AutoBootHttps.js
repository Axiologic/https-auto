...
exports.getHttpsOptions = function(keysFolder, requestCert, rejectUnauthorized, callback){
...
exports.startServer = function(port, keysFolder, callback){
    exports.getHttpsOptions (keysFolder, false, false, function(error, options){
...
exports.startMutualAuthServer = function(port, keysFolder, callback){
    exports.getHttpsOptions (keysFolder, true, true, function(error, options){
        console.log("Starting https server on port", port);
        var server = https.createServer(options, callback);
        server.listen(port);
        return server;
